...
/*
 * jcl_handle_connect
 *  connects to PTP4L implementation
 *
 * Arguments:
 *  handle	: (out) handle to sptplib connection instance
 *  path	: (in)  path to PTP4L instance, use NULL for default pathname
 *
 * Return:
 *  < 0 : error code
 *    0 : success
 *
 * On failure, handle is invalid, NULL path argument uses default
 */
