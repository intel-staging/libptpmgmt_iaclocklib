...
struct Nm(TimeBaseCfg) {
    ...
    arr(char,udsAddrChrony,STRING_SIZE_MAX); /**< Unix domain socket address for Chrony */
    arr(char,udsAddrPtp4l,STRING_SIZE_MAX); /**< Unix domain socket address for ptp4l */
    arr(char,interfaceName,STRING_SIZE_MAX); /**< Network interface name for ptp4l */
