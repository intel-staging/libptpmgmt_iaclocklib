...
class ClockEventHandler
{
  public:
     ...
     * @param[in] event The ClockEventBase object to modify.
     * @param[in] clockOffsetInRange True if the offset is in range,
     * false otherwise.
     */
    static void setOffsetInRange(ClockEventBase &event, bool clockOffsetInRange) {
        event.offsetInRange = clockOffsetInRange;
    }
