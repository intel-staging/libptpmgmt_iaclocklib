...
/** @file
 * @brief ClockSyncData class unit tests
 *
...
TEST(ClockEventBaseTest, DefaultConstructor_InitializesMembers)
{
...
// uint32_t getGmChangedEventCount() const
// uint64_t getNotificationTimestamp() const
TEST(ClockEventBaseTest, SettersAndGetters_WorkCorrectly)
{
    ClockEventBaseTestable event;
...
// uint64_t getGmIdentity() const
// uint64_t getNotificationTimestamp() const
TEST(ClockEventBaseTest, Setters_BoundaryValues)
{
    ClockEventBaseTestable event;
...
TEST(PTPClockEventTest, DefaultConstructor_InitializesMembers)
{
...
// bool isCompositeEventMet() const
// uint32_t getCompositeEventCount() const
TEST(PTPClockEventTest, SettersAndGetters_WorkCorrectly)
{
    PTPClockEventTestable event;
...
// uint32_t getAsCapableEventCount() const
// uint32_t getCompositeEventCount() const
TEST(PTPClockEventTest, Setters_BoundaryValues)
{
    PTPClockEventTestable event;
    ClockEventHandler handler(ClockEventHandler::PTPClock);
...
// bool isOffsetInRange() const
// uint32_t getOffsetInRangeEventCount() const
TEST(SysClockEventTest, DefaultConstructor_InitializesBaseMembers)
{
...
// bool havePTP() const
// bool haveSys() const
TEST(ClockSyncDataTest, DefaultConstructor_InitializesAvailability)
{
    ClockSyncData data;
...
// ClockEventHandler::setClockOffset()
// int64_t getClockOffset() const
TEST(ClockSyncDataTest, GetPtpAndSysClock_ReturnsReferences)
{
    ClockSyncData data;
...
// bool isOffsetInRange() const
// bool isGmChanged() const
TEST(ClockEventBaseTest, ToggleBooleanFlags)
{
    ClockEventBaseTestable event;
    ClockEventHandler::setOffsetInRange(event, true);
    EXPECT_TRUE(event.isOffsetInRange());
...
// bool isAsCapable() const
// bool isCompositeEventMet() const
TEST(PTPClockEventTest, ToggleBooleanFlags)
{
    PTPClockEventTestable event;
    ClockEventHandler handler(ClockEventHandler::PTPClock);
    handler.setSyncedWithGm(event, true);
